...
import com.bike.entidades.Menu;
import com.bike.controlador.util.JsfUtil;
import com.bike.controlador.util.JsfUtil.PersistAction;
...
public class MenuController implements Serializable {
    ...
    @EJB
    private com.bike.controlador.MenuFacade ejbFacade;
    ...
    public static class MenuControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Menu) {
                Menu o = (Menu) object;
                return getStringKey(o.getMeCodigo());
            } else {
